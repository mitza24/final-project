    ...
    return (
      <Grid>
        ...
        <Row className="cardRow"> 
          <Col xs={1} md={3}>
            <ButtonToolbar vertical className="cardsContainer">
                <Button  block bsStyle="primary" className="buttoncards">Weddings Cards</Button>
                <Button  block bsStyle="primary" className="buttoncards">Baptism Cards</Button>
                <Button  block bsStyle="primary" className="buttoncards">Birthdays Cards</Button>
              </ButtonToolbar>
          </Col>
      </Row>
          <Col xs={8}>
